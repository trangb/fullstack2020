...
describe('total likes', () => {
  ...
  test('when list has multiple blogs, equals all the likes', () => {
...
describe('favorite blogs', () => {
  ...
  test('when list has multiple entries, equals the blog with most likes', () => {
    const fav = {
...
describe('most likes', () => {
  test('when list has only one blog equals the # of likes', () => {
    const most = {
      author: 'Edsger W. Dijkstra',
      likes: 5
    }
